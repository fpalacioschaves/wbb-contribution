...
<div class="js-login-wp">
    <span class="btn btn-info">New User WP</span>
    <div class="wp-login-form js-wp-login-form">
        <label>User Name</label>
        <input type="text" class="js-login-new-user-form-user" value="" />
        <label>E-Mail</label>
        <input type="text" class="js-login-new-user-form-email" value="" />
        <label>Password</label>
        <input type="password" class="js-login-new-user-form-password" value="" />
        <div class="btn btn-danger js-new-user">Register</div>
    </div>
</div>
